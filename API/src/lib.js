...
async function fetchSeasons() {
  try {
    ...
    const url = `https://api.sportradar.com/soccer-extended/trial/v4/hr/seasons?api_key=${config.API.sportTrader}`;
...
async function getSeasons(year) {
  try {
    ...
    return ouput
      .sort((a, b) => parseInt(a.competition_id.split(":").at(-1)) - parseInt(b.competition_id.split(":").at(-1)))
      .reverse();
  } catch (error) {
    console.log(error);
  }
...
async function fetchCompetitions() {
  try {
    ...
    const url = `https://api.sportradar.com/soccer-extended/trial/v4/hr/competitions?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getSeasonSchedules(seasonId) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/seasons/${seasonId}/schedules.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getPlayerStats(seasonId) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/seasons/${seasonId}/leaders.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getStandings(seasonId) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/seasons/${seasonId}/standings.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getFormStandings(seasonId) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/seasons/${seasonId}/form_standings.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getTimeline(sportEvent) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/sport_events/${sportEvent}/timeline.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getLineup(sportEvent) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/sport_events/${sportEvent}/lineups.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
...
async function getSummary(sportEvent) {
  try {
    ...
    const url = `https://api.sportradar.com/soccer/trial/v4/hr/sport_events/${sportEvent}/summary.json?api_key=${config.API.sportTrader}`;
    const response = await axios.get(url, {
      headers: {
        accept: "application/json",
      },
